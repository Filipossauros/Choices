  ...
  return (
    <div className="max-w-4xl mx-auto py-6 px-4 space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <button
          onClick={exportPDF}
          className="flex flex-col items-center gap-1.5 px-3 py-3 bg-accent hover:bg-accent-strong text-white rounded-xl transition-colors"
        >
        ...
        <button
          onClick={exportCSV}
          disabled={!result}
          className="flex flex-col items-center gap-1.5 px-3 py-3 bg-positive hover:bg-positive-strong disabled:opacity-40 text-white rounded-xl transition-colors"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
